...
public final class JsonEvent extends Event {
    ...
    public String toString() {
        try {
            ...
            log.error("Invalid json data, Failed to serialize JsonEvent to String", ex);
            throw new HecException("Failed to serialize JsonEvent to String", ex);
        }
    }
    ...
    public byte[] getBytes() {
        ...
        try {
            ...
            log.error("Invalid json data, Failed to serialize JsonEvent to Byte[]", ex);
            throw new HecException("Failed to serialize JsonEvent to Byte[]", ex);
        }
        return bytes;
    }
}
