...
public class UnitUtil {
    ...
    final String enrichments = "ni=hao";
    final Map<String, String> enrichmentMap = new HashMap<>();
    ...
    public Map<String, String> createTaskConfig() {
        ...
        config.put(SplunkSinkConnectorConfig.HEC_URI_CONF, uri);
        ...
        config.put(SplunkSinkConnectorConfig.EVENT_BATCH_TIMEOUT_CONF, String.valueOf(eventBatchTimeout));
        ...
        config.put(SplunkSinkConnectorConfig.ENRICHMENT_CONF, String.valueOf(enrichments));
